...
- **Go to Symbol** (Navigate → Symbol) now finds Gleam top-level declarations — functions, constants, custom types, and their record constructors — across project sources and indexed dependencies
