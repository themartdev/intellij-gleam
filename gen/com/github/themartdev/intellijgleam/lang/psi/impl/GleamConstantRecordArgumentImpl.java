...
public class GleamConstantRecordArgumentImpl extends ASTWrapperPsiElement implements GleamConstantRecordArgument {

  public GleamConstantRecordArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GleamVisitor visitor) {
    visitor.visitConstantRecordArgument(this);
  }
