...
public class GleamFunctionDeclarationImpl extends ASTWrapperPsiElement implements GleamFunctionDeclaration {
  ...
  @Override
  @NotNull
  public GleamBlock getBlock() {
    return findNotNullChildByClass(GleamBlock.class);
  }

  @Override
  @Nullable
  public GleamParameterList getParameterList() {
    return findChildByClass(GleamParameterList.class);
  }
